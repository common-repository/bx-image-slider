...
// Attributes 
	...
	if(!empty($atts)):
		...
		if($atts['image'][$i]){
			...
			echo '<li><img src="';echo $atts['image'][$i];echo '" />';
...
<td>
<fieldset><legend class="screen-reader-text"><span>Default Slider settings</span></legend>
<label><input type="checkbox" class="form-control" name="bcontrols" value="true" <?php if(get_option( 'bcontrols' )):?> checked <?php endif;?> > controls</label>
<br>
<label><input type="checkbox" class="form-control"   name="binfiniteLoop" value="true" <?php if(get_option( 'binfiniteLoop' )):?> checked <?php endif;?> > infiniteLoop</label>
<br>
<label><input type="checkbox" class="form-control"   name="bautoStart" value="true" <?php if(get_option( 'bautoStart' )):?> checked <?php endif;?> > autoStart</label>
<br>
<label><input type="checkbox" class="form-control"  name="bpager" value="true" <?php if(get_option( 'bpager' )):?> checked <?php endif;?> /> pager</label>
<br>
